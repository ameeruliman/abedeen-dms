    ...
    <Layout>
      <div className="admin-panel">
        ...
        <div className="container">
          ...
          {/* Register Admin Section (Only for Super Admin) */}
          {adminUser.department.toLowerCase() === "superadmin" && (
            <div className="accordion-section">
              <div className="accordion-header" onClick={() => toggleSection('registerAdmin')}>
                <div className="accordion-title">
                  <i className="fas fa-user-plus"></i>
                  Register New Admin
                </div>
                <i className={`fas fa-chevron-down accordion-arrow ${expandedSections.registerAdmin ? 'expanded' : ''}`}></i>
              </div>
              {expandedSections.registerAdmin && (
                <div className="accordion-content">
                  <div className="accordion-subsection">
                    <div className="subsection-header" onClick={() => toggleSection('registerAdminForm')}>
                      <div className="subsection-title">
                        <i className="fas fa-user-plus"></i>
                        Add New Administrator
                      </div>
                      <i className={`fas fa-chevron-down subsection-arrow ${expandedSections.registerAdminForm ? 'expanded' : ''}`}></i>
                    </div>
                    {expandedSections.registerAdminForm && (
                      <div className="subsection-content">
                        {registerAdminMessage && (
                          <div className={`message ${registerAdminMessage.includes("successfully") ? "success" : "error"}`}>
                            {registerAdminMessage}
                          </div>
                        )}
                        ...
                        <form onSubmit={handleRegisterAdmin} className="admin-form">
                          ...
                          <div className="form-group">
                            <label htmlFor="newAdminDepartment">Department (Role)</label>
                            <select
                              id="newAdminDepartment"
